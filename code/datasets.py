...
def get_imgs(img_path, imsize, bbox=None,
    ...
    '''
      We resize the full image to be 126 X 126 (instead of 128 X 128) 
      for the full coverage of the input (full) image by
      the receptive fields of the final convolution layer of 
    ...
    crop_re_fimg = re_fimg.crop(
        [crop_start_x, crop_start_y,
         crop_start_x + my_crop_width, crop_start_y + my_crop_width])
