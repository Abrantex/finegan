...
class G_NET(nn.Module):
    ...
    def forward(self, z_code, c_code, p_code=None, bg_code=None):
        ...
        fake_imgs = []
        # Will contain [background image, parent image, child image]
        fg_imgs = []
        # Will contain [parent foreground, child foreground]
        mk_imgs = []
        # Will contain [parent mask, child mask]
        fg_mk = []
        # Will contain [masked parent foreground, masked child foreground]
        ...
        '''
        Resizing fake background image from 128x128 to the resolution 
        which background discriminator expects: 126 x 126.
        '''
...
class D_NET(nn.Module):
    ...
    def forward(self, x_var):
        ...
        if self.stg_no == 0:
            ...
            score (0 - background and 1 - foreground)
            '''
            ...
            ''' 
              Predicts the parent code and child code in 
              parent and child stage respectively
            '''
